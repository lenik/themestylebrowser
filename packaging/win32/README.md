...
.\build.ps1 -Name themestylebrowser -Version 1.2.3
```
...
```
<project>/.config/themestylebrowser/<packaging>.build-host
$HOME/.config/themestylebrowser/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/themestylebrowser
```
