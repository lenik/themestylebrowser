...
ImagePropertiesDialog::ImagePropertiesDialog(wxWindow* parent, const wxString& title,
    ...
    while (styleId.EndsWith("/"))
        styleId.RemoveLast();
    wxString sizeStr = wxString::Format(tr("%lld bytes"), (long long)ie->size);
    ...
    top->Add(new wxStaticText(this, wxID_ANY, tr("Theme Style:")), 0, wxALL, 2);
    ...
    wxButton* copyStyle = new wxButton(this, wxID_ANY, tr("Copy"));
